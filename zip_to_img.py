...
def unzip_single(src_file):
     ...
     dest_dir = src_file.replace('.zip','').replace('denseflow', 'denseflow_img').replace('windows4t', 'second2t').replace('larger_video', 'larger_video1').replace('ARD2000', 'LAD2000')
...
if __name__ == "__main__":
    zip_files = []
    zip_files_tmp = glob.glob('/home/tu-wan/windows4t/dataset/UCF_Crime/denseflow/*/*/img.zip')
