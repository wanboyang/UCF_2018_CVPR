...
parser.add_argument('--model_name', default='model_ucf', help=' ')
...
parser.add_argument('--feature_size', type=int, default=4096, help='size of feature (default: 2048)')
...
parser.add_argument('--dataset_name', type=str, default='UCF_Crime', help='')
...
parser.add_argument('--max-seqlen', type=int, default=32, help='maximum sequence length during training (default: 750)')
parser.add_argument('--Lambda', type=str, default='1_0_0', help='')
parser.add_argument('--seed', type=int, default=1, help='random seed (default: 1)')
parser.add_argument('--max_epoch', type=int, default=200, help='maximum iteration to train (default: 50000)')
parser.add_argument('--feature_pretrain_model', type=str, default='c3d_segments', help='type of feature to be used I3D or C3D (default: I3D)')
parser.add_argument('--feature_layer', type=str, default='fc6', help='fc6 or fc7')
parser.add_argument('--k', type=int, default=1, help='value of k')
